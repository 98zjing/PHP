...
EOF;
      ...
      <ul id="main-nav">
        ...
        <li> <a href="index.php?publish=1" class="nav-top-item no-submenu">
          ...
          添加新文章 </a> </li>
        <li> <a href="index.php?index=1" class="nav-top-item ">
        ...
        <li style="<?php if(isset($_SESSION['admin']) && $_SESSION['admin']['Juris'] == 'a'){ echo "display: block"; }else{echo "display: none;";}?>"><a href="index.php?user" class="nav-top-item current"> 管理员 </a>
          <ul>
